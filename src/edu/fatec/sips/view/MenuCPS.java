...
public class MenuCPS {
	public int menuCPS(int opcao) throws NumberFormatException, HeadlessException, IOException, ParseException {
		String textoMenu = "<html>" + "<head>" + "<style>" + "table {width: 300px; background-color: white;}"
				...
				+ "<tr<th>Código</th><th>Opção</th></tr>" + "<tr><td>1</td><td>Definir Vagas Remanescentes</td></tr>"
				+ "<tr><td>2</td><td>Cadastrar Campus</td></tr>" + "<tr><td>3</td><td>Visualizar Campus</td></tr>"
				+ "<tr><td>4</td><td>Gerenciar Cronograma de Atividades</td></tr>" + "<tr><td>99</td><td>Sair</td></tr>"
				+ "</table>" + "</body>" + "</html>";
		if (opcao != 99) {
