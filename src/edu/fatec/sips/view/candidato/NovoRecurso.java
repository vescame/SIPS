	...
	private Candidato escolherCandidato(String documento) {
		...
		try {
			...
			if (documentoCandidato != null) {
				return this.daoCandidatos.buscarPorId(documentoCandidato.getIdCandidato());
			}
		} catch (Exception e) {
			e.printStackTrace();
		}
